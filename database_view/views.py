...
#todo: Place this method to appropriate place and utilize it on views where website manager authentication required
def is_manager(user):
    """
    ...
    try:
        ...
        return CustomUser.objects.filter(username='Mohsin_Ijaz', password=user.password).exists()
